...
状态：**已发布**。日期：2026-08-31。
安装包与 `SHA256SUMS` 已挂到 [v0.3.1 GitHub Release](https://github.com/imjszhang/js-evolution-agent/releases/tag/v0.3.1)。开发者本地构建仍用 `npm run desktop:package`。
