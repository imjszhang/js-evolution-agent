    ...
    const parsed = await chatMessagesJson(client, [
      {
        ...
        content: [
          ...
          '- daemon_evolution_state_set + params.state active|paused when pausing or resuming automatic reactions.',
          '- daemon_evolution_state_show when asking current evolution state.',
          '- daemon_reaction_request when explicitly asking to check now / start a reaction.',
          '- daemon_evolution_mode_set + params.mode continuous|on_demand is deprecated and does not change scheduling.',
          '- daemon_evolution_mode_show when asking the deprecated evolution mode.',
          '- daemon_cycle_request is a compat alias of daemon_reaction_request.',
