...
export function buildPresenceContext(root, subject, {
  ...
  const signals = collectAttentionSignals(root, subject, { projection });
  ...
  return {
    ...
    channel: {
      ...
      recent_ingested: summarizeRecentIngested(root, subject, { limit: limits.ingested ?? 8 }),
    ...
    attention_signals: signals.slice(0, limits.signals ?? 12),
