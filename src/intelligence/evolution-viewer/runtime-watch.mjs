...
export function runtimeWatchPaths(runtimeRoot, {
  ...
  const paths = [
    ...
    join(runtimeRoot, 'data', 'evolution', 'reactor', 'claims.json'),
    join(runtimeRoot, 'data', 'evolution', 'reactor', 'archive', 'claims.jsonl'),
    join(runtimeRoot, 'data', 'evolution', 'reactor', 'archive', 'claims-covered-index.json'),
    join(runtimeRoot, 'data', 'evolution', 'reactor', 'archive', 'claims-summary.json'),
