  ...
  return {
    ...
    schema_guards: [
      ...
      },
      {
        ...
        rule: 'Treat as narrative/model cache unless a structured schema is directly read in the current cycle.',
      },
      {
...
export function formatObservationEvidenceGuard(guard) {
  return [
    ...
    '',
    'This section is mandatory. It prevents previous hallucinated file claims from becoming current facts.',
    '',
    '### Source Requirements',
    ...
    '- Historical reports, previous observations, standing_memory, and diary prose are clues only; they are not current file facts.',
    ...
    '- Treat `data/intelligence/memory/standing_memory.json` as a model-summary cache unless the current cycle directly reads a different structured schema.',
