...
本目录是 JEA 0.3.1 macOS 产品身份、启动器与打包路径的 owner。已发布产品是 [v0.3.1](https://github.com/imjszhang/js-evolution-agent/releases/tag/v0.3.1)。
...
| 最低 macOS | 13.0 |
| 产物 | `JEA-0.3.1-macos-arm64.dmg` / `.zip` |
